function ee()
{
    ...
    let regex = [];
    return {
        emit(e,...vals){map[e]?map[e].forEach(f => f(...vals)):0;regex.forEach(o=>e.match(o.p)==null?0:o.f(...vals));e!="*"?map["*"].forEach(f=>f(e,...vals)):0;return this},
        on(e,f){e instanceof RegExp?regex.push({p:e,f:f}):map[e]?map[e].push(f):(map[e]=[]).push(f);return this},
